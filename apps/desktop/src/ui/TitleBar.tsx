// 自繪視窗標題列（ADR-0150）：`decorations: false` 後這條就是視窗最外框。
// 只在 Tauri 下掛載（瀏覽器版外框是瀏覽器的，管不到）；視窗動作經 `actions` 注入——
